    ...
    <section className='py-[40px] px-[20px] lg:px-[50px] lg:py-[50px]'>
        ...
        <div className='min-[600px]:flex max-w-[950px] mx-auto mb-[50px]'>
            <div className='mb-5 min-[600px]:w-[50%] min-[600px]:mb-0'>
                <img src="https://raw.githubusercontent.com/RaulTindogan/SHINU/master/public/assets/Women-Hoodies/Women's-Spider-Web-Zipper-Hoodie.jpg" alt="" className='w-full min-[600px]:h-[400px]' />
            </div>
            <div className='min-[600px]:w-[50%] min-[600px]:pl-[20px] min-[600px]:pt-1 md:py-2 md:px-[50px]'> 
                ...
                <Link to={"/products/20"}><button className='border border-black rounded py-[10px] px-[20px] bg-[#FFB800] font-bold'>Buy Now</button></Link>
            </div>
        </div>
