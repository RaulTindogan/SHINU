            ...
            <div className='lg:w-[100%]'>
                ...
                <div>
                    ...
                    <form action="#" className='w-full flex h-[40px]'>
                        ...
                        <button type="submit" className='flex justify-center items-center w-[20%] bg-[#FFB800]'><img src="https://raw.githubusercontent.com/RaulTindogan/SHINU/master/public/assets/Plain.png" alt="" className='w-[30px]'/></button>
                    </form>             
                </div>
            </div>
        </div>
            ...
            <div className='bg-[#FFF8F8] lg:w-[50%]'>
                <ul className='flex flex-wrap justify-evenly items-center'>
                    <li className="cursor-pointer w-[17%]">
                        <img src="https://raw.githubusercontent.com/RaulTindogan/SHINU/master/public/assets/Paypal-Logo.png" alt="" />
                    </li>
                    <li className="cursor-pointer w-[17%]">
                        <img src="https://raw.githubusercontent.com/RaulTindogan/SHINU/master/public/assets/American-Express.png" alt="" />
                    </li>
                    <li className="cursor-pointer w-[17%]">
                        <img src="https://raw.githubusercontent.com/RaulTindogan/SHINU/master/public/assets/Amazon-Logo.png" alt="" />
                    </li>
                    <li className="cursor-pointer w-[17%]">
                        <img src="https://raw.githubusercontent.com/RaulTindogan/SHINU/master/public/assets/Visa_Logo.png" alt="" />
                    </li>
                </ul>
            </div>
        </div>
